...
sudo docker exec NF2 ovs-ofctl add-flow br0 in_port=2,ip,nw_src=192.168.1.4/32,nw_dst=192.168.1.1/32,actions=set_queue:123,output:1
sudo docker exec NF2 ovs-ofctl add-flow br0 in_port=1,ip,nw_src=192.168.1.1/32,nw_dst=192.168.1.4/32,actions=set_queue:234,output:2
