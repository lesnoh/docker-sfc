...
docker exec NF1 ovs-ofctl add-flow br0 in_port=1,ip,nw_src=192.168.1.1/32,nw_dst=192.168.1.2/32,actions=output:2
docker exec NF1 ovs-ofctl add-flow br0 in_port=2,ip,nw_src=192.168.1.2/32,nw_dst=192.168.1.1/32,actions=output:1
